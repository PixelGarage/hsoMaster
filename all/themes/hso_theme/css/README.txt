...
To use these stylesheets, rename the files and hso_theme with the name of your theme.
...
hso_theme-alpha-default-narrow.css  
...
hso_theme-alpha-default-normal.css
...
hso_theme-alpha-default-wide.css
